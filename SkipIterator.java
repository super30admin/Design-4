// Time Complexity :Advance()-> O(n)worst case hasNext->constant skip,next->O(n) as we are calling advance in it
// Space Complexity :constant ,as we only consider auxiliary data structure used in method and map is in constructor
