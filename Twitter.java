/**
 * Time Complexity : For each tweet, postTweet = O(1), follow = O(1), unfollow = O(1), getNewsFeed = O(nm +  mlog k)  where m is the number of tweets and n is the number of users
